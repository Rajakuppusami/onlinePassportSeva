		...
		<div class="row">
			...
			<div class="col-3 md-3 ">
				<div class="card h-100">
					<center>
						<h5 class="card-header">View Registered Applicant's</h5>
					</center>
					<div class="card-body">
					...
					<div class="card-footer">
						...
						<a href="viewallapplicant" class="btn btn-primary">Click here </a>
					</div>
				</div>
			</div>
			...
			<div class="col-3  md-3">
				<div class="card h-100">
					<center>
						<h5 class="card-header">View Scheduled Applicant's</h5>
					</center>
					<div class="card-body">
					...
					<div class="card-footer">
						<a href="viewallschedulers" class="btn btn-primary">Click here </a>
					</div>
				</div>
			</div>
			<div class="col-3 md-3">
				<div class="card h-100">
					<center>
						<h5 class="card-header">View Rescheduling And Cancellation</h5>
					</center>
					<div class="card-body">
